...
date: "2014-10-11"
published: "2014-10-11T14:09:00.000-07:00"
slug: "password-security-why-the-horse-battery-staple-is-not-correct"
tags: ["passwords"]
deadImages: []
---
...
![](/content/images/2016/08/xkcd_comic.png)
...
With the advent of password managers, the large majority of all passwords should just be randomly generated, and replaced with a single password that provides access to all the others. This solves both the strength and memorability problems for 95% of your passwords[1](#fn1).

![](/content/images/2016/08/password_pie.png)
...
![](/content/images/2016/08/nsa_eagle.jpg)
...
This means that we should stop blindly classifying password strength based on the number of bits of entropy[3](#fn3), and should consider first and foremost how dictionary-attack resistant the passwords is.
...
1. Not derived from real data. [↩](#ffn1)
2. If you analyze any of the large password leaks of the last few years you will notice that people tend to use the name of the service as part of their passwords. [↩](#ffn2)
3. Obviously a decent minimum number of characters should still be enforced.[↩](#ffn3)
