...
description: "I've had to change my MAC address for countless reasons. Either because I was doing some penetration testing, or just to debug some network errors..."
date: "2011-01-16"
published: "2011-01-16T13:49:00.000-08:00"
slug: "change-your-mac-with-py-mactool"
tags: ["macOS", "wifi"]
deadImages: []
---
...
The most recent motive for changing my MAC Address was: fun. I had set up airdrop-ng ([http://www.aircrack-ng.org/doku.php?id=airdrop-ng](http://www.aircrack-ng.org/doku.php?id=airdrop-ng&ref=blog.diogomonica.com)) to drop all wireless clients from my university wireless network, except the ones whose MAC address begins with DE:AD:BE:EF. Obviously, I configured the MAC addresses of all my hosts to begin with that prefix.

![](/images/ext/a4d3edc5a8-tumblr_lf4fkqSO761qevk7j.png)
...
Thus, py-MACtool ([https://github.com/diogomonica/py-MACtool](https://github.com/diogomonica/py-MACtool)) was born. It works on both Linux and OS X, generating and changing the MAC address of a chosen interface, also allowing: the random generation of a MAC address; generation of a random MAC address beginning with a given prefix; and also, generation of a random MAC address from any manufacturer (I'm using the wireshark's manufacturer list as the source).
